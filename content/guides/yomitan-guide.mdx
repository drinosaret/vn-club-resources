...
Under **Dictionaries**, you can add a frequency sort dictionary. This is the main frequency dictionary used to sort all of your results. I recommend using JPDB, [Jiten](https://jiten.moe/), a BCCWJ variant, or CC100.
