...
sitemap:
  ...
  changefreq: monthly
faq:
  - q: "What Anki settings should I use for learning Japanese?"
    a: "Enable FSRS scheduling with 0.90 desired retention, set new cards to 10-15 per day, and set maximum reviews to 9999 (unlimited). Use a single 10-minute learning step and only press Again or Good during reviews. The PassFail add-on removes Hard and Easy buttons to enforce this simple workflow."
  - q: "What is FSRS and why should I use it for Anki?"
    a: "FSRS is Anki's modern scheduling algorithm that's more accurate than the default. It solves 'ease hell' where cards get stuck in frustrating review patterns. Enable it in Deck Options under Advanced, set desired retention to 0.90, and click Optimize to tune it to your memory patterns. Re-optimize monthly for best results."
  - q: "What Anki deck should I start with for Japanese?"
    a: "Start with Kaishi 1.5k, which contains the 1500 most common Japanese words with example sentences designed for immersion learners. Download the .apkg file and import it into Anki. Once you start reading visual novels, switch to mining your own vocabulary using JL or Yomitan with the AnkiConnect add-on."
  - q: "How do I know if I really know an Anki card?"
    a: "You must get the reading correct, not just recognize the kanji. Then check if you can visualize or recall the core meaning. If you hesitate more than a few seconds, press Again. When in doubt, fail the card. You're training recognition, not production. Deeper understanding comes from seeing words repeatedly while reading visual novels."
---
