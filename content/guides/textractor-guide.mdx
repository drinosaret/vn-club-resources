---
description: How to use Textractor for visual novels. Setup guide for text hooking, WebSocket extension, texthooker UI, regex patterns, and mobile access for Japanese learners.
sitemap:
  priority: 0.9
  changefreq: monthly
---
