...
- [Kizuna Texthooker](https://kizuna-texthooker-ui.fly.dev/) - Alternative with leaderboards | [VNCR Room](https://kizuna-texthooker-ui.fly.dev/rooms/vncr)
- [JL](/jl-guide)
...
1. Open [Renji-XD's Texthooker UI](https://renji-xd.github.io/texthooker-ui/) or [Kizuna Texthooker](https://kizuna-texthooker-ui.fly.dev/) in your browser. If the WebSocket is working, the colored icon in the top right should be green. If it's still red, trying clicking on it to reconnect.
