---
description: How to use JDownloader for downloading visual novels from DDL sites. Setup guide covering split archives, automatic extraction, browser extension, and premium accounts.
sitemap:
  priority: 0.8
  changefreq: monthly
---

# JDownloader Setup Guide
...
![Jdownloader General Settings](assets/jdownloader3.webp)
...
![Jdownloader Extraction settings](assets/jdownloader2.webp)
...
![Top Menu Settings](assets/jdownloader4.webp)
...
2. **Configuration**: Before starting your download, configure:
    ...
    - Priority settings
![Jdownloader downloads screen](assets/jdownloader5.webp)

3. **Start Download**: Right-click on the package and select "Start Downloads"
![Start Download](assets/jdownloader6.webp)
...
![Context menu options](assets/Jdownloader7.webp)
