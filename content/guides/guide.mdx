...
<div className="path">
  <div className="path-stage">
    <h3 className="path-stage-name">Foundation<span className="path-stage-when">1 week</span></h3>
    <div className="path-steps">
      <span className="path-step">🔤 Learn Kana</span>
      <span className="path-step">📚 Kaishi</span>
      <span className="path-step">📝 Basic Grammar</span>
    </div>
  </div>
  <div className="path-stage">
    <h3 className="path-stage-name">Active Learning<span className="path-stage-when">1-6 months</span></h3>
    <div className="path-steps">
      <span className="path-step">🛠️ Setup Tools</span>
      <span className="path-step">📖 Pick VN</span>
      <span className="path-step">🎮 Read</span>
      <span className="path-step">⛏️ Mine</span>
      <span className="path-step">🔄 Build a Routine</span>
    </div>
  </div>
  <div className="path-stage">
    <h3 className="path-stage-name">Mastery<span className="path-stage-when">6+ months</span></h3>
    <div className="path-steps">
      <span className="path-step">🎯 Read More</span>
      <span className="path-step">🚀 出来る</span>
    </div>
  </div>
</div>
...
<div className="aside-cta">
  <h4 className="aside-cta-name">Looking for your first visual novel?</h4>
  <p className="aside-cta-body">Browse our hand-picked beginner-friendly VNs and discover easy-difficulty titles to start reading Japanese.</p>
  <a href="/beginner-vns/" className="aside-cta-go">Browse Beginner VN Recommendations <span aria-hidden>→</span></a>
</div>
