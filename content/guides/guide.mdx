...
**Setup:** Follow [our Anki guide](/anki-guide) for complete installation and configuration.
...
!!! success "JL - Recommended for VN Readers"
    ...
    **Setup:** Follow [our JL guide](/jl-guide) for complete installation and configuration.
...
!!! info "Text Hooking"
    Text hookers like [Textractor](/textractor-guide) extract text from VNs so you can copy, look up, and mine vocabulary without manually typing Japanese characters.

**What it does:** Hooks into VN processes and extracts displayed text in real-time for easy dictionary lookups.

**Setup:** Follow [our complete Textractor guide](/textractor-guide) for installation and configuration.

**Key features:** Compatible with most VNs, supports extensions, WebSocket integration for browser dictionaries

**Alternative tools:** If Textractor doesn't work with your game, try [Agent](/agent-guide) for script-based hooking or [OwOCR](/owocr-guide) for OCR-based text extraction.
