...
<div className="my-8 space-y-4">
  <div className="rounded-lg bg-blue-50 dark:bg-blue-950/30 p-4 border border-blue-200 dark:border-blue-800">
    ...
    <div className="flex flex-wrap items-center justify-center gap-2 text-sm">
      <span className="px-3 py-1.5 bg-white dark:bg-gray-800 rounded-md shadow-xs border border-blue-100 dark:border-blue-900">🔤 Learn Kana</span>
      <span className="text-blue-400">→</span>
      <span className="px-3 py-1.5 bg-white dark:bg-gray-800 rounded-md shadow-xs border border-blue-100 dark:border-blue-900">📚 Kaishi</span>
      <span className="text-blue-400">→</span>
      <span className="px-3 py-1.5 bg-white dark:bg-gray-800 rounded-md shadow-xs border border-blue-100 dark:border-blue-900">📝 Basic Grammar</span>
    </div>
  </div>
  ...
  <div className="rounded-lg bg-green-50 dark:bg-green-950/30 p-4 border border-green-200 dark:border-green-800">
    ...
    <div className="flex flex-wrap items-center justify-center gap-2 text-sm">
      <span className="px-3 py-1.5 bg-white dark:bg-gray-800 rounded-md shadow-xs border border-green-100 dark:border-green-900">🛠️ Setup Tools</span>
      <span className="text-green-400">→</span>
      <span className="px-3 py-1.5 bg-white dark:bg-gray-800 rounded-md shadow-xs border border-green-100 dark:border-green-900">📖 Pick VN</span>
      <span className="text-green-400">→</span>
      <span className="px-3 py-1.5 bg-white dark:bg-gray-800 rounded-md shadow-xs border border-green-100 dark:border-green-900">🎮 Read</span>
      <span className="text-green-400">→</span>
      <span className="px-3 py-1.5 bg-white dark:bg-gray-800 rounded-md shadow-xs border border-green-100 dark:border-green-900">⛏️ Mine</span>
      <span className="text-green-400">→</span>
      <span className="px-3 py-1.5 bg-white dark:bg-gray-800 rounded-md shadow-xs border border-green-100 dark:border-green-900">🔄 Build a Routine</span>
    </div>
  </div>
  <div className="flex justify-center text-2xl text-gray-400">↓</div>
  <div className="rounded-lg bg-orange-50 dark:bg-orange-950/30 p-4 border border-orange-200 dark:border-orange-800">
    ...
    <div className="flex flex-wrap items-center justify-center gap-2 text-sm">
      <span className="px-3 py-1.5 bg-white dark:bg-gray-800 rounded-md shadow-xs border border-orange-100 dark:border-orange-900">🎯 Read More</span>
      <span className="text-orange-400">→</span>
      <span className="px-3 py-1.5 bg-white dark:bg-gray-800 rounded-md shadow-xs border border-orange-100 dark:border-orange-900">🚀 出来る</span>
    </div>
  </div>
</div>
...
- **[Yokubi](https://yoku.bi/)** - Open-source rewrite and rearrangement of Sakubi
