...
<img height="490" width="540" alt="Agent window" src="assets/agent1.webp" />
...
![Agent settings](/assets/agent5.webp)

## Usage

### Basic Operation

1. **Select Target**: To select a target, you can supply a file directory to an exe file or you can more simply click and drag the target icon on to your target game. Clicking the dropdown menu next to the target icon and selecting "Create Process" will bring up a file picker allowing you to select a target.<img height="453" width="200" alt="Agent target icon" style="width: 200px; display: block; margin: 1.5em auto 2em auto;" src="assets/agent2.webp" />![Agent target icon drag](/assets/agent3.webp)
