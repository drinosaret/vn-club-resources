...
from app.api.v1 import stats, recommendations, vn, user, news, admin, logs, characters, browse, blacklist, vn_of_the_day, shared
...
api_router.include_router(admin.router, prefix="/admin", tags=["admin"], include_in_schema=False)
api_router.include_router(logs.router, prefix="/logs", tags=["logs"], include_in_schema=False)
