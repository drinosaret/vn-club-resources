    ...
    return (
      <section className="vn-sec p-4 sm:p-5">
        <div className="vn-sec-head">
          <h2 className="vn-sec-title">Users Also Read</h2>
        </div>
          ...
          <div className="relative" ref={tooltipRef}>
            ...
            {showTooltip && (
              <div
                ...
                role="tooltip"
                className="on-box absolute left-1/2 -translate-x-1/2 sm:translate-x-0 sm:left-0 top-8 z-50 w-64 sm:w-72 p-2.5 rounded-xs bg-[color:var(--box)] text-[color:var(--ink-box)] text-xs"
              >
    ...
    <VNCard
      ...
      badge={
        <span className="vn-mark bottom-1.5 left-1.5">
          {vn.user_count ? `${vn.user_count} readers` : `${Math.round(vn.similarity * 100)}% match`}
        </span>
      }
    />
  );
