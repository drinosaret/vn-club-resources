...
// Matches grid: grid-cols-2 / sm:grid-cols-3 / md:grid-cols-4 / lg:grid-cols-5
export const CARD_IMAGE_SIZES =
  '(max-width: 640px) calc(50vw - 24px), (max-width: 768px) calc(33vw - 20px), (max-width: 1024px) calc(25vw - 18px), 180px';
