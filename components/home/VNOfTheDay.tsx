...
export function VNOfTheDay({ data }: VNOfTheDayProps) {
  ...
  return (
    <section
      className={`pt-0 pb-8 md:pb-12 bg-gray-50 dark:bg-gray-900/50 transition-opacity duration-500 ${isReady ? 'opacity-100' : 'opacity-0'}`}
    >
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5 md:p-6">
          <div className="flex flex-col sm:flex-row gap-5 md:gap-6">
            ...
            <div className="flex flex-col min-w-0 flex-1">
              {/* Badge */}
              <span className="inline-flex items-center gap-1 self-start px-2.5 py-0.5 rounded-full text-xs font-medium bg-primary-100 dark:bg-primary-900/30 text-primary-700 dark:text-primary-400 mb-2">
                VN of the Day
              </span>
