...
function FeaturedVNCard({ vn, preference }: { vn: FeaturedVNData; preference: 'japanese' | 'romaji' }) {
  ...
  return (
    <Link
      ...
      className="group"
    >
      <div className="relative overflow-hidden rounded-lg shadow-lg group-hover:shadow-xl transition-[box-shadow,transform] duration-300 group-hover:-translate-y-1">
