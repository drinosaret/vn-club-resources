...
export function BoardHeaderSkeleton() {
  return (
    <header className="mb-6" aria-hidden="true">
      {/* Title. */}
      <div className="h-9 w-2/3 rounded-xs image-placeholder" />
      ...
      <div className="mt-2 flex h-12 max-w-2xl flex-col justify-between">
        <div className="h-5 rounded-xs image-placeholder" />
        <div className="h-5 w-4/5 rounded-xs image-placeholder" />
      </div>
      ...
      <div className="mt-3 flex flex-wrap items-center gap-x-4 gap-y-2">
        <div className="h-5 w-24 rounded-xs image-placeholder" />
        <div className="h-5 w-64 rounded-xs image-placeholder" />
      </div>

      {/* Disclosure button: a label inside the tap target the real button reserves. */}
      <div className="mt-4 flex h-11 items-center">
        <div className="h-4 w-40 rounded-xs image-placeholder" />
      </div>
    </header>
  );
}
