                ...
                <div key={section.name}>
                  {section.items ? (
                        ...
                        <div className="ml-4 border-l-2 border-gray-200 dark:border-gray-700 pl-4 space-y-1">
                          {section.items.map((item) => (
                            <Link
                              ...
                              className="block text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors py-1.5 text-sm"
                            >
                              {item.name}
                            </Link>
                          ))}
                    ...
                    <Link
                      href={section.href!}
                      onClick={() => setIsMenuOpen(false)}
                      className="block text-gray-700 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors py-2 font-medium"
                    >
                      {section.name}
                    </Link>
                  )}
