...
export const metadata: Metadata = {
  ...
  alternates: localizedAlternates('3x3-maker', 'ja'),
};
  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-2xl px-4 py-12 font-jp text-sm text-[color:var(--nezu)]">
        ...
        <h3 className="mt-4 mb-1 font-display font-bold text-[color:var(--ink)]">グリッドサイズとレイアウト</h3>
        ...
        <h3 className="mt-4 mb-1 font-display font-bold text-[color:var(--ink)]">クロップと編集</h3>
        ...
        <h3 className="mt-4 mb-1 font-display font-bold text-[color:var(--ink)]">表示設定</h3>
        ...
        <p className="mb-3">グリッドはアイテム、クロップ位置、カスタムタイトル、スコアを含めてブラウザに自動保存されます。いつでも戻ってくれば、前回のままの状態でグリッドが残っています。</p>
