const en = {
  ...
  'share.loading': 'Loading shared tier list…',
  ...
  'controls.exportFormat': 'Export format',
  'controls.exportScale': 'Export resolution (1x, 1.5x or 2x)',
  ...
  // TierListBoard: autosave status
  'status.lastSaved': 'Last autosaved: {time}',
  'status.draftCleared': 'Draft cleared',
  ...
  'tierFill.vnsPlaceholder': 'Search VNs by title or VNDB ID (e.g. v17)...',
  'tierFill.charsPlaceholder': 'Search characters by name, title or VNDB ID (e.g. c123)...',
  ...
  'tierItem.tapToReveal': 'Tap to reveal',
  'tierItem.clickToReveal': 'Click to reveal',
  ...
  'howItWorks.autoSave.body': 'Everything is saved to your browser automatically: tier layouts, item assignments, custom titles, scores, and display settings. Come back anytime and your tier list will be right where you left it.',
} as const;
...
const ja: Record<TierListKeys, string> = {
  ...
  'controls.exportFormat': 'エクスポート形式',
  'controls.exportScale': 'エクスポート解像度 (1x・1.5x・2x)',
  ...
  // TierListBoard: autosave status
  'status.lastSaved': '最終自動保存: {time}',
  'status.draftCleared': '下書きをクリアしました',
  ...
  'tierFill.vnsPlaceholder': 'タイトルまたはVNDB IDで検索 (例: v17)...',
  'tierFill.charsPlaceholder': 'キャラクター名・作品名・VNDB IDで検索 (例: c123)...',
  ...
  'tierItem.edit': '\u7de8\u96c6',
  'tierItem.remove': '\u524a\u9664',
  'tierItem.tapToReveal': 'タップして表示',
  'tierItem.clickToReveal': 'クリックして表示',
  ...
  'howItWorks.autoSave.body': '\u30c6\u30a3\u30a2\u306e\u30ec\u30a4\u30a2\u30a6\u30c8\u3001\u30a2\u30a4\u30c6\u30e0\u306e\u914d\u7f6e\u3001\u30ab\u30b9\u30bf\u30e0\u30bf\u30a4\u30c8\u30eb\u3001\u30b9\u30b3\u30a2\u3001\u8868\u793a\u8a2d\u5b9a\u306a\u3069\u3001\u3059\u3079\u3066\u304c\u30d6\u30e9\u30a6\u30b6\u306b\u81ea\u52d5\u4fdd\u5b58\u3055\u308c\u307e\u3059\u3002\u3044\u3064\u3067\u3082\u623b\u308c\u3070\u3001\u96e2\u308c\u305f\u3068\u304d\u306e\u307e\u307e\u306e\u72b6\u614b\u3067\u3059\u3002',
};
